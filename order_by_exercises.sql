...
ORDER BY first_name;
-- returns 709 rows
-- first and last name in the first row irena retaneur 
-- last person first and last name: vidya simmen

-- 3. Find all employees with first names 'Irena', 'Vidya', or 'Maya', and order your results returned by first name and then last name. In your comments, answer: What was the first and last name in the first row of the results? 
-- What was the first and last name of the last person in the table?
SELECT first_name, last_name
FROM employees
WHERE first_name IN ('Irena', 'Vidya','Maya')
...
-- last person vidya zweizig

-- 4. Find all employees with first names 'Irena', 'Vidya', or 'Maya', and order your results returned by last name and then first name. In your comments, answer: What was the first and last name in the first row of the results? 
-- What was the first and last name of the last person in the table?
SELECT first_name, last_name
FROM employees
WHERE first_name IN ('Irena', 'Vidya','Maya')
...
ORDER BY emp_no;
-- 899 rows
-- first emp_no 10021 erde ramzi
-- last row 499648 erde tadahiro
...
-- 362 rows
-- oldest emp hired last khun bernini
-- youngest emp hired first douadi pettis 